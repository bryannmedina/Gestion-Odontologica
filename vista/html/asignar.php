...
<html>
    <head>
        <title>Asingar Cita</title>
        <link rel="stylesheet" type="text/css" href="Vista/css/estilos.css">
        <script type=" text/javascript" src="vista/jquery/jquery-3.7.1.min.js"> </script>
        <script  scr="vista/jquery/jquery-ui-1.14.1.custom/jquery-ui.js" type="text/javascript"> </script>
        <link rel="stylesheet" href="vista/jquery/jquery-ui-1.14.1.custom/jquery-ui.css" type="text/css">
        ...
        <div id="contenido">
            ...
            <form id="frmasignar" action="index.php?accion=guardarCita" method="post">
                <table>
                    ...
                    <tr>
                        <td colspan="2"><input type="button" value="Consultar" name="consultarConsultar" id="consultarConsultar" onclick="consultarPaciente()"></td>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
